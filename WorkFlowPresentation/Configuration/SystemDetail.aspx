<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemDetail.aspx.cs" Inherits="WorkFlowPresentation.Configuration.SystemDetail" %>
		...
		<table class="tableBorder" id="table2" height="151" cellSpacing="1" cellPadding="3" border="0" style=" HEIGHT: 129px">
			<tr>
				<td id="tabletitlelink" style="FONT-WEIGHT: bold; FONT-SIZE: large; BACKGROUND-IMAGE: url(images/admin_bg_1.gif); COLOR: white; BACKGROUND-COLOR: #44aaaa; width: 100%;"
					align="center" colspan="6" height="25">System Detail</td>
			</tr>
			<tr>			    
							...
							<td style="height: 10px">
							    <table>							    
						            ...
						            <tr>
							            ...
							            <td align="left" class="style3">
                                            <asp:TextBox ID="txbBUrl" runat="server" Width="454px" ReadOnly="True"></asp:TextBox>
                                            </td>
						            </tr>
						            <tr>
						                <td align="right" class="style2" >
							            ...
							            <td align="left" class="style3">
                                            <asp:TextBox ID="txbSUrl" runat="server" Width="454px" ReadOnly="True"></asp:TextBox>
                                            </td>
						            </tr>
						            <tr>
						                <td align="right" class="style2" >
						                    Apply Url:</td>
							            <td align="left" class="style3">
                                            <asp:TextBox ID="txbApplyUrl" runat="server" Width="453px" ReadOnly="True"></asp:TextBox>
                                            </td>
						            </tr>
						            <tr>
						                <td align="right" class="style2" >
						                    Query Url:</td>
							            <td align="left" class="style3">
                                            <asp:TextBox ID="txbQueryUrl" runat="server" Width="452px" ReadOnly="True"></asp:TextBox>
                                            </td>
						            </tr>
						            <tr>
						                <td align="right" class="style2" >
						                    Navigate Url: </td>
							            <td align="left" class="style3">
                                            <asp:TextBox ID="txbNavigateUrl" runat="server" Width="452px" ReadOnly="True"></asp:TextBox>
                                            </td>
						            </tr>
						            <tr>
						            ...
						            <tr>
							            <td style="height: 15px" align="center" colspan="2">
                                           <asp:Button ID="btnAdd" runat="server" Text="Return" Width="83px" 
